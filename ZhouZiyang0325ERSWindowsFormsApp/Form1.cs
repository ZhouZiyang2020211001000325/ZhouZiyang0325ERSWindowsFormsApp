...
namespace ZhouZiyang0325ERSWindowsFormsApp
{
    public partial class EmployeeRecordFrom : Form
    {
        private TreeNode tvRootNode;

        public EmployeeRecordFrom()
        {
            InitializeComponent();
            PopulateTreeView();
        ...
        private void EmployeeRecordFrom_Load(object sender, EventArgs e)
        {
        ...
        private void PopulateTreeView()
        {
            ...
            XmlTextReader reader = new XmlTextReader("F:\\vis\\code\\1\\ZhouZiyang0325ERSWindowsFormsApp\\EmpRec.xml");
            ...
            try
            {
                ...
                statusBarPanel1.Text = ("Click on an employee code to see their recode.");
            }
        ...
        {
            InitalizeListControl();
            XmlTextReader listRead = new XmlTextReader("F:\\vis\\code\\1\\ZhouZiyang0325ERSWindowsFormsApp\\EmpRec.xml");
